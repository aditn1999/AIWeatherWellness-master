...
import {  sunIcon } from '@/app/utils/Icons';
...
function Uvindex() {
  ...
  return (
    <div className="pt-6 pb-5 px-4 h-[12rem] border rounded-lg flex flex-col bg-zinc-100 hover:hover-effect  dark:hover:border-gray-900  gap-5 dark:bg-dark-grey shadow-lg  dark:shadow-none">
     <div className="top">
        <h2 className="flex items-center gap-2  font-bold dark:font-medium">{sunIcon} Uv Index</h2>
        <div className="pt-4 flex flex-col gap-1">
          <p className="text-2xl">
            {uvIndexMax}
            <span className="text-sm  font-bold dark:font-medium">
      ...
      <p className="text-sm font-semibold dark:font-medium">{uvIndexCategory(uvIndexMax).protection} </p>
    </div>
  )
}
