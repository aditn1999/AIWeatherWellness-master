...
function Humidity() {
  ...
  return (
    <div className="pt-6 pb-5 px-4 h-[12rem] border rounded-lg flex flex-col gap-8 dark:bg-dark-grey  dark:shadow-none shadow-lg bg-zinc-100 hover:hover-effect  dark:hover:border-gray-900">
      <div className="top">
      ...
      <p className="text-sm  font-semibold dark:font-medium">{getHumidityText(humidity)}.</p>
    </div>
  );
}
