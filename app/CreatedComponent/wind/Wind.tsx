...
function Wind() {
  ...
  return (
    <div
      className="pt-6 pb-5 px-4 h-[12rem] border rounded-lg flex  bg-zinc-100
    flex-col gap-3 dark:bg-dark-grey shadow-lg dark:shadow-none   hover:hover-effect  dark:hover:border-gray-900"
    >
      ...
      <div className="compass relative flex items-center justify-center">
        <div className="image relative">
          ...
          <Image
            ...
            alt="compass"
            className="absolute top-0 left-[50%] transition-all duration-5000 ease-in-out dark:invert"
            style={{
