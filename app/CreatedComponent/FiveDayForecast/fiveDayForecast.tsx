...
import { CelsiusConvertor, unixToDay } from "@/app/utils/mist";
...
function FiveDayForecast() {
  ...
  const processData = (
    ...
    return {
      ...
      minTemp: CelsiusConvertor(minTemp),
      maxTemp: CelsiusConvertor(maxTemp),
    };
  };
  ...
  return (
    <div
      className="pt-6 pb-5 px-4 flex-1 border rounded-lg flex flex-col
        justify-between dark:bg-dark-grey shadow-lg bg-zinc-100 hover:hover-effect  dark:hover:border-gray-900 dark:shadow-none"
    >
      <div>
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 flex items-center justify-between gap-4">
                  ...
                  <div className="temperature flex-1 w-full  h-1.5 rounded-lg"></div>
